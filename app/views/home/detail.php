<div class="container mt-4" style="background-color: rgb(239, 240, 255);">
    ...
    <div class="card">
      <div class="card-body row m-0">
        ...
        <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0 pe-2">
          ...
          <div class="row mt-3">
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repudiandae officiis earum ullam quis eaque
              corrupti eligendi non distinctio debitis, quisquam nam voluptate voluptas, quia quaerat doloribus quasi
              adipisci tempora consequatur.</p>
          </div>
          <div class="row">
            <div class="col-4">
              Quantity
  ...
  <div class="row mt-5 mb-6">
    ...
    <h3 class="ms-0 ps-0 mb-2">
      Overall review: 4,6
      <a href="">
        <svg id="Products_-_Star_ratings" data-name="Products - Star ratings" xmlns="http://www.w3.org/2000/svg"
          width="216" height="24" viewBox="0 0 216 24">
          ...
          <g id="Group_503" data-name="Group 503" transform="translate(-413)">
            <g id="Icons_Actions_ic-actions-star" data-name="Icons / Actions / ic-actions-star"
              ...
              <g id="ic-actions-star" transform="translate(1.954 2.42)">
                <path id="Path_38" data-name="Path 38"
                  ...
                  transform="translate(-1.959 -2.435)" fill="#ddd" fill-rule="evenodd" />
              </g>
            </g>
            <g id="Icons_Actions_ic-actions-star-2" data-name="Icons / Actions / ic-actions-star"
              transform="translate(491)">
              ...
              <g id="ic-actions-star-2" data-name="ic-actions-star" transform="translate(1.954 2.42)">
                <path id="Path_38-2" data-name="Path 38"
                  d="M11,3.19a1.08,1.08,0,0,1,2.06,0l1.86,5.72h6a1.09,1.09,0,0,1,.64,2l-4.87,3.53,1.86,5.73a1.08,1.08,0,0,1-1.67,1.21L12,17.81,7.13,21.35a1.08,1.08,0,0,1-1.67-1.21l1.86-5.73L2.45,10.88a1.09,1.09,0,0,1,.64-2h6Z"
                  transform="translate(-1.959 -2.435)" fill="#fba422" fill-rule="evenodd" />
              </g>
            </g>
            <g id="Icons_Actions_ic-actions-star-3" data-name="Icons / Actions / ic-actions-star"
              ...
              <g id="ic-actions-star-3" data-name="ic-actions-star" transform="translate(1.954 2.42)">
                <path id="Path_38-3" data-name="Path 38"
                  d="M11,3.19a1.08,1.08,0,0,1,2.06,0l1.86,5.72h6a1.09,1.09,0,0,1,.64,2l-4.87,3.53,1.86,5.73a1.08,1.08,0,0,1-1.67,1.21L12,17.81,7.13,21.35a1.08,1.08,0,0,1-1.67-1.21l1.86-5.73L2.45,10.88a1.09,1.09,0,0,1,.64-2h6Z"
                  transform="translate(-1.959 -2.435)" fill="#fba422" fill-rule="evenodd" />
              </g>
            </g>
            <g id="Icons_Actions_ic-actions-star-4" data-name="Icons / Actions / ic-actions-star"
              ...
              <g id="ic-actions-star-4" data-name="ic-actions-star" transform="translate(1.954 2.42)">
                <path id="Path_38-4" data-name="Path 38"
                  d="M11,3.19a1.08,1.08,0,0,1,2.06,0l1.86,5.72h6a1.09,1.09,0,0,1,.64,2l-4.87,3.53,1.86,5.73a1.08,1.08,0,0,1-1.67,1.21L12,17.81,7.13,21.35a1.08,1.08,0,0,1-1.67-1.21l1.86-5.73L2.45,10.88a1.09,1.09,0,0,1,.64-2h6Z"
                  transform="translate(-1.959 -2.435)" fill="#fba422" fill-rule="evenodd" />
              </g>
            </g>
            <g id="Icons_Actions_ic-actions-star-5" data-name="Icons / Actions / ic-actions-star"
              ...
              <g id="ic-actions-star-5" data-name="ic-actions-star" transform="translate(1.954 2.42)">
                <path id="Path_38-5" data-name="Path 38"
                  d="M11,3.19a1.08,1.08,0,0,1,2.06,0l1.86,5.72h6a1.09,1.09,0,0,1,.64,2l-4.87,3.53,1.86,5.73a1.08,1.08,0,0,1-1.67,1.21L12,17.81,7.13,21.35a1.08,1.08,0,0,1-1.67-1.21l1.86-5.73L2.45,10.88a1.09,1.09,0,0,1,.64-2h6Z"
                  transform="translate(-1.959 -2.435)" fill="#fba422" fill-rule="evenodd" />
              </g>
            </g>
          </g>
          <text id="_183_reviews" data-name="183 reviews" transform="translate(216 18)" fill="#888" font-size="14"
            font-family="SegoeUI, Segoe UI" text-decoration="underline">
    ...
    <div class="card pe-0 mt-2">
      ...
      <div class="row mt-2 me-0 ps-0 pe-0 me-0">
        <div class="col-6">
          ...
          <div class="row">
            <p><svg id="Icons_Actions_ic-actions-check" data-name="Icons / Actions / ic-actions-check"
                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <rect id="Rectangle_139" data-name="Rectangle 139" width="24" height="24" fill="none" />
                <g id="ic-actions-check">
                  <path id="Path_9" data-name="Path 9" d="M6.56,12.85l3.06,3.06,7.82-7.82" fill="none" stroke="#1170ff"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2" fill-rule="evenodd" />
                  <circle id="Ellipse_2" data-name="Ellipse 2" cx="10" cy="10" r="10" transform="translate(2 2)"
                    fill="none" stroke="#1170ff" stroke-linecap="round" stroke-linejoin="bevel" stroke-width="2" />
                </g>
              </svg>
          ...
          <div class="row">
            <p><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22">
                <g id="ic-actions-close" transform="translate(-1 -1)">
                  <circle id="Ellipse_3" data-name="Ellipse 3" cx="10" cy="10" r="10" transform="translate(2 2)"
                    fill="none" stroke="#888" stroke-linecap="round" stroke-linejoin="bevel" stroke-width="2" />
                  <line id="Line_16" data-name="Line 16" x1="7.07" y1="7.07" transform="translate(8.66 8.59)"
                    fill="none" stroke="#888" stroke-linecap="round" stroke-linejoin="bevel" stroke-width="2" />
                  <line id="Line_17" data-name="Line 17" y1="7.07" x2="7.07" transform="translate(8.66 8.59)"
                    fill="none" stroke="#888" stroke-linecap="round" stroke-linejoin="bevel" stroke-width="2" />
                </g>
              </svg>
        ...
        <div class="row pe-0 me-0">
          <div class="col text-start">
            <p><svg id="Avatar_-_Name_-_S" data-name="Avatar - Name - S" xmlns="http://www.w3.org/2000/svg" width="32"
                height="32" viewBox="0 0 32 32">
                <circle id="Ellipse_40" data-name="Ellipse 40" cx="16" cy="16" r="16" fill="#1170ff" />
                <text id="PB" transform="translate(16 21)" fill="#fff" font-size="14"
          ...
          <div class="col text-end">
            <p><svg xmlns="http://www.w3.org/2000/svg" width="225" height="24" viewBox="0 0 225 24">
                <g id="Group_638" data-name="Group 638" transform="translate(-923 -3259)">
                  ...
                  <text id="_11._6._2020" data-name="11. 6. 2020" transform="translate(1004 3277)" fill="#888"
                    font-size="17" font-family="SegoeUI, Segoe UI">
    ...
    <div class="row-auto p-0 mt-5">
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col text-start">
              <h6><svg id="Avatar_-_Name_-_S" data-name="Avatar - Name - S" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row-auto p-0 mt-5">
      ...
      <div class="row mt-3">
        <div class="col-3">
          <!--product 1-->
          <div class="card">
            <a class="text-center" href=""><img class="card-img-center p-3 "
                style="width:100%;height:13rem;object-fit:cover;" src="<?= URLROOT; ?>/img/banner.jpg"></a>
